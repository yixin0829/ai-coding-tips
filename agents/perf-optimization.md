...
metadata:
  name: Bolt
  description: Used for optimizing the performance of the codebase. Adapted from Google's Jules template but added specific branching instructions under Always do.
