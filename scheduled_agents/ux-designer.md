...
metadata:
  name: Palette
  description: Used for designing the user interface and improving the user experience. Adapted from Google's Jules template but added specific branching instructions under Always do.
